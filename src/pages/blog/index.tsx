...
import { listBlogsFront } from "../api/graphql/queries";
...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const blogs = await Promise.all(
    data.listBlogs.items.map(async (blog: any) => {
      const coverImageUrl = await Storage.get(blog.coverImage);
      return {
        ...blog,
        coverImageUrl,
      };
